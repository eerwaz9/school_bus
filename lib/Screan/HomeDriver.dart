...
class HomeDriverScrean extends StatefulWidget {
  @override
  _HomeDriverScreanPageState createState() => _HomeDriverScreanPageState();
}
...
class _HomeDriverScreanPageState extends State<HomeDriverScrean> {
  int _counter = 0;
...
// You can request multiple permissions at once.
  ...
  SaveLocation(LocationDriver _locationDriver) async {
    ...
    setState(() {
      ...
      if (_driverMode) if (mapController != null)
  ...
  onChangeDropdownTetcher(selectedTetcher) {
    ...
    if (DataScoolAndDriverChooseLocal.getDriverIdFromRefrences() != null &&
      ...
      //       .pushReplacement(MaterialPageRoute(builder: (ctx) => HomeDriverScrean()));
      // }
    }
  }
  ...
  bool checkPermetionLocation;

  // checkPermetion() async {
  //   if(await Permission.location.isGranted){
  //     checkPermetionLocation=true;
  //   }else{
  //     checkPermetionLocation=false;
  //   }
  //
  //
  // }
  ...
  chechAndSave() async {
    ...
    //             latitude: locationData.latitude,
    //             Driver:
    //             "https://mubus.pythonanywhere.com/api/v1/DriverBus/${ await DataUserLocal
    //                 .getIdDriverFromDataBase()}/",
    //             IMEI_device: getInfoDivice.identifier,
    //             Name_Location: addresses == null || addresses.length <= 0
    //                 ? " NULL "
    //                 : "${addresses == null || addresses.length <= 0
    //                 ? " "
    //                 : addresses[0].countryName},${addresses == null ||
    //                 addresses.length <= 0 ? " " : addresses[0]
    //                 .adminArea}, ${addresses == null || addresses.length <= 0
    //                 ? " "
    //                 : addresses[0].subAdminArea},"
    //                 " ${addresses == null || addresses.length <= 0
    //                 ? " "
    //                 : addresses[0].countryCode} ,  ${addresses == null ||
    //                 addresses.length <= 0 ? " " : addresses[0]
    //                 .addressLine},  ${addresses == null || addresses.length <= 0
    //                 ? " "
    //                 : addresses[0].featureName} ,"
    //                 " ${addresses == null || addresses.length <= 0
    //                 ? " "
    //                 : addresses[0].postalCode}  , ${addresses == null ||
    //                 addresses.length <= 0 ? " " : addresses[0]
    //                 .locality} , ${addresses == null || addresses.length <= 0
    //                 ? " "
    ...
    //             latitude: locationData.latitude,
    //             longitude: locationData.longitude,
    //             Driver: "https://mubus.pythonanywhere.com/api/v1/DriverBus/${await DataUserLocal
    //                 .getIdDriverFromDataBase()}/",
    //
    //             IMEI_device: getInfoDivice.identifier,
    //             Name_Location:
    ...
    //                 ? " "
    //                 : addresses[0].countryName},${addresses == null ||
    //                 addresses.length <= 0 ? " " : addresses[0].postalCode},'
    //                 " ${addresses == null || addresses.length <= 0
    //                 ? " "
    //                 : addresses[0].featureName} ,  ${addresses == null ||
    //                 addresses.length <= 0 ? " " : addresses[0]
    //                 .addressLine} '"}",
    //           );
    //
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (ctx) => HomeDriverScrean()));
                },
              ),
              ListTile(
                leading: Icon(
